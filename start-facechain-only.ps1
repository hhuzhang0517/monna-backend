...
# 添加datasets到PYTHONPATH确保它能被找到
$env:PYTHONPATH = "$env:PYTHONPATH;$PWD/venv310/Lib/site-packages"
Write-Host "已将site-packages添加到PYTHONPATH" -ForegroundColor Green
...
# 启动独立的FaceChain FastAPI应用程序
Write-Host "启动FaceChain独立API应用..." -ForegroundColor Green
python -m uvicorn run_facechain_api:app --host 0.0.0.0 --port 8000 --reload 